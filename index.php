...
<body>
    ...
    <!-- Navigation -->
    <?php require_once 'nav.php'; ?>   <!-- Link to the nav.php file conataining navigation. -->
                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/bg1.jpg" alt="">
                            </div>
                            <div class="item">
